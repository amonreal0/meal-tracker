...
Update this when staples are bought or run out. The "starter pantry" below is the
...
- **Durable staples** below are checked off as *likely on hand* — they were in the first
  order and don't get used up in one week (jars, oils, vinegars, dry goods). Boxes still
  unchecked were either used up (broth, crushed tomatoes, 8oz noodles) or never confirmed.
...
- [ ] Frozen spinach
- [ ] Frozen peas / corn
- [ ] Extra bread/rolls (sandwich insurance)

## Fridge staples that last reasonably
- [ ] Eggs — out, rebuy
- [ ] Parmesan / pecorino
- [ ] Feta
- [ ] Greek yogurt
- [ ] Tortillas
- [ ] Pickles / pepperoncini / hot cherry peppers
- [ ] Capers
